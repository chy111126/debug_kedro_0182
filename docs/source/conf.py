...
# old_kedro_proj documentation build
...
from old_kedro_proj import __version__ as release

# -- Project information -----------------------------------------------------

project = "old_kedro_proj"
author = "Kedro"
...
htmlhelp_basename = "old_kedro_projdoc"
...
texinfo_documents = [
    (
        ...
        author,
        "old_kedro_proj",
        "Project old_kedro_proj codebase.",
        "Nearest-Neighbour",
    )
]
